...
module StoreApi
  ...
  module Request
    ...
    # @params [String] path
    # @params [Hash] proxy [:host=>'host',:port=>port]
    # @params [String] request get/post
    # @params [Hash] params
    # @return [Object] response
    def request(host,path,rest='get',https=false,proxy=nil,option=nil,params=nil)
      ...
      if response.code.to_i > 500
        ...
        response = request(redirect_url.host,redirect_url.path,rest,https,proxy,option,params)
      else
        @redirect_count = 0
        response
      end
